...
for img in os.listdir('../images'):
    ...
    # plt.imshow(bw)
    # plt.show()
    bw = skimage.morphology.binary_opening(bw, skimage.morphology.disk(1))
    # print("Second\n")
    # plt.imshow(bw_thicker)
    # plt.show()
    #bw = skimage.morphology.binary_closing(bw, skimage.morphology.disk(1))
